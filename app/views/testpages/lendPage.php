...
<title>MoneyLink - The real P2P finance hub - Registration</title>
  ...
  document.getElementById("saveLendPref").disabled = true;
 }

  function activateButton(element) {

      if(element.checked) {
        document.getElementById("saveLendPref").disabled = false;
       }
       else  {
        document.getElementById("saveLendPref").disabled = true;
      }
...
<!-- 
         ...
         {{ Form::close() }} -->
          ...
          {{ Form::open(array('action'=>'LenderPrefController@saveLendPref','name'=>'regForm','id'=>'regForm')) }}
      	...
      	<!-- 	<form action="register.php" method="post" name="regForm" id="regForm" > -->
                ...
                <tr>
                  <td colspan="2">
                         <br>
                          {{ Form::submit('saveLendPref',null,array('id'=>'saveLendPref','value'=>'save','type'=>'submit')) }}
